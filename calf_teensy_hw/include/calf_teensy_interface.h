#ifndef CALF_TEENSY_INTERFACE_H_
#define CALF_TEENSY_INTERFACE_H_
...
class CalfTeensyInterface
{
 private:
  DriverSerialPortPtr serial_port;
  unsigned int timeout;
 public:
 CalfTeensyInterface(unsigned int timeout = 10):
...
typedef boost::shared_ptr<CalfTeensyInterface> CalfTeensyInterfacePtr;
