...
class CalfHWSim : public gazebo_ros_control::RobotHWSim
{
private:
...
typedef boost::shared_ptr<CalfHWSim> CalfHWSimPtr;

}

PLUGINLIB_EXPORT_CLASS(calf_gazebo::CalfHWSim, gazebo_ros_control::RobotHWSim)
