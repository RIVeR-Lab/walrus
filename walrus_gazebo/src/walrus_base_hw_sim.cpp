...
class WalrusBaseHWSim : public gazebo_ros_control::RobotHWSim
{
private:
...
std::vector<std::string> WalrusBaseHWSim::POD_POSITIONS = boost::assign::list_of("front")("back");
std::vector<std::string> WalrusBaseHWSim::DRIVE_SIDES = boost::assign::list_of("left")("right");
double WalrusBaseHWSim::EFFORT_MULTIPLIER = 10.0;

}

PLUGINLIB_EXPORT_CLASS(walrus_gazebo::WalrusBaseHWSim, gazebo_ros_control::RobotHWSim)
